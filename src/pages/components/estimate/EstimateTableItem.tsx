...
export interface EstimateTableItemProps {
  key: string
  id: string
  estimate_id: number
  customer_name: string
  customer_email: string
  estimate_created_date?: number
  amount: string
  createdAt: number
  isChecked: boolean
  handleChecked: any
...
function EstimatesTableItem(props: EstimateTableItemProps) {
        ...
        <td className="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
          <div className="flex items-center">
            <div className="m-1.5">
              {/* Start */}
              <button
                className="btn bestimate-slate-200 hover:bestimate-slate-300"
                onClick={() => {
                  props.handleEdit(props.id)
                }}
              >
...
export default EstimatesTableItem
