...
export interface ReviewsActivityCardProps {
  activityList: Activity[]
}
function ReviewsActivityCard(props: ReviewsActivityCardProps) {
  ...
  return (
    <div className="col-span-full xl:col-span-6 bg-white shadow-lg rounded-sm border border-slate-200">
      <header className="px-5 py-4 border-b border-slate-100">
        <h2 className="font-semibold text-slate-800">Recent Review Request</h2>
      </header>
      <div className="p-3">
        {/* Card content */}
        {/* "Today" group */}
...
export default ReviewsActivityCard
