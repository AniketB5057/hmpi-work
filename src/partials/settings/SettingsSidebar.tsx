...
import { allowedSidebarMenu } from "../Sidebar"
      ...
      <div>
        ...
        {userInfo && userInfo.roles && (
          <ul className="flex flex-nowrap md:block mr-3 md:mr-0">
            ...
            {allowedSidebarMenu(
              ...
              <li className="mr-0.5 md:mr-0 md:mb-0.5">
                <NavLink
                  ...
                  className={`flex items-center px-2.5 py-2 rounded whitespace-nowrap ${
                    pathname.includes("/settings/account/business") &&
                    "bg-indigo-50"
                  }`}
                >
                  <svg
            ...
            {allowedSidebarMenu(userInfo.roles, "/settings/preferrences") && (
              <li className="mr-0.5 md:mr-0 md:mb-0.5">
                <NavLink
                  end
                  to="/settings/preferrences"
                  className={`flex items-center px-2.5 py-2 rounded whitespace-nowrap ${
                    pathname.includes("/settings/preferrences") &&
                    "bg-indigo-50"
                  }`}
                >
                  <svg
            ...
            {allowedSidebarMenu(userInfo.roles, "/settings/apps") && (
              <li className="mr-0.5 md:mr-0 md:mb-0.5">
                <NavLink
                  end
                  to="/settings/apps"
            ...
            {allowedSidebarMenu(userInfo.roles, "/settings/plans") && (
              <li className="mr-0.5 md:mr-0 md:mb-0.5">
                <NavLink
                  end
                  to="/settings/plans"
            ...
            {allowedSidebarMenu(userInfo.roles, "/settings/billing") && (
              <li className="mr-0.5 md:mr-0 md:mb-0.5">
                <NavLink
                  end
                  to="/settings/billing"
